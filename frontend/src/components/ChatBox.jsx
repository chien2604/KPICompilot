      ...
      <div className="chatbox2__messages">
        {messages.length === 0 ? (
          <div className="chatbox2__empty">
            ...
            <div className="chatbox2__empty-sub">Hỏi tôi về KPI, nhiệm vụ, hoặc hiệu suất cán bộ</div>
          </div>
        ) : (
          messages.map((msg) => (
            <div key={msg.message_id} className={`chatbox2__msg chatbox2__msg--${msg.role}`}>
        ...
        {loading && (
          <div className="chatbox2__msg chatbox2__msg--assistant">
            <div className="chatbox2__avatar chatbox2__avatar--assistant"><RobotOutlined /></div>
