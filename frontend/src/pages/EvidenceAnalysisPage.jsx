...
/** Render the evidence analysis page interface. */
export default function EvidenceAnalysisPage() {
  ...
  const load = () =>
    evidenceApi.analysis(evidenceId).then((data) => {
      setAnalysis(data);
      if (data?.task_id) {
        apiClient
          .get(`/tasks/${data.task_id}`)
              ...
              >
                {task ? (
                  ...
                  <span style={{ color: "#94a3b8", fontSize: 13 }}>
                    Đang tải thông tin nhiệm vụ #{analysis.task_id}...
                  </span>
                )}
              </Card>
            )}
              ...
              <Row gutter={24} align="middle">
                ...
                <Col flex="auto">
                  ...
                  >
                    ...
                    <Paragraph
                      style={{ margin: 0, color: "#475569", fontSize: 16 }}
                    >
                    ...
                    renderItem={(item) => (
                      ...
                      >
                        <Space align="start" style={{ width: "100%" }}>
                          ...
                          <div style={{ flex: 1 }}>
                            <Text strong={!item.met} style={{ fontSize: 16 }}>
                              {item.item}
                            </Text>
                            {item.note && (
                              <div
